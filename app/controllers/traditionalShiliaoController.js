...
angular.module("app").controller("traditionalShiliaoController",["traMedical","$scope","$rootScope","$state",function(
    ...
    $rootScope.pageLoading = true;
      ...
      console.log($scope.traSearchTree);
		...
		$scope.showlevel3 = function (class1,class2,class3,class4,class5) {
			//console.log(names);
			$state.go("app.traditionalShiliaoList",{"class1":class1,"class2":class2,"class3":class3,
        "class4":class4,"class5":class5});
		};
}])
 .controller("traditionalShiliaoListController",["$scope","$rootScope","traMedical","$stateParams",
